      ...
      <CardContent className="grid gap-6">
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <Input id="collection-name" value={collectionData.nome} onChange={(e) => onDataChange('nome', e.target.value)} placeholder="Ex: Corrida 5k Santos / Ensaio Fotográfico" />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="collection-category">Categoria</Label>
            <Select value={collectionData.categoria} onValueChange={(value) => onDataChange('categoria', value)}>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <Input id="collection-date-start" type="date" value={collectionData.dataInicio} onChange={(e) => onDataChange('dataInicio', e.target.value)} />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="collection-date-end">Fim do Evento</Label>
            <Input id="collection-date-end" type="date" value={collectionData.dataFim} onChange={(e) => onDataChange('dataFim', e.target.value)} />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <Textarea id="collection-description" value={collectionData.descricao} onChange={(e) => onDataChange('descricao', e.target.value)} placeholder="Conte mais sobre como foi o evento..." className="h-24" />
        </div>
      </CardContent>
    </Card>
  );
