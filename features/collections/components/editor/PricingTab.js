            ...
            {collectionData.descontos?.map((discount, index) => (
              ...
              >
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="absolute top-2 right-2 h-6 w-6 text-muted-foreground hover:text-red-500 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity"
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-2 mt-4 sm:mt-0">
                  ...
                  <ArrowLeft className="hidden sm:block h-4 w-4 text-muted-foreground rotate-180" />
