...
const REAL_IMAGES: Record<string, string> = {
  ...
  water: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e",
  ...
  cycling: "https://images.unsplash.com/photo-1571333250630-f0230c320b6d",
  running: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438",
  volleyball:
...
const CATEGORY_IMAGES: Record<string, string> = {
  ...
  Handebol: REAL_IMAGES.basketball,
  ...
  Pescaria: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e",
...
const withUnsplashParams = (url: string, w = 600, q = 75): string => {
...
export const metadata = {
  title: "Categorias",
  description: "Explore fotos por categorias de eventos e esportes.",
};
