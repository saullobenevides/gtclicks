...
import { CartPageSkeleton } from "@/components/shared/Skeletons";
...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="container-wide px-4 relative flex min-h-[60vh] flex-col items-center justify-center py-16 sm:py-24">
        ...
        <EmptyState
          ...
          description="Explore nossa galeria de fotos exclusivas e encontre a imagem perfeita para o seu projeto."
                  ...
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    <span>
                      ...
                      {typeof item.licenca === "object"
                        ? (item.licenca as { nome?: string })?.nome
                        : item.licenca}
                    </span>
                  </div>
                </div>
          ...
          <Card className="glass-panel border-white/10 bg-black/40">
              ...
              {(() => {
                ...
                if (firstItem?.descontos && firstItem.descontos.length > 0) {
                  const nextDiscount = firstItem.descontos
                    .filter((d: { min: number }) => d.min > count)
                    .sort(
            ...
            <CardFooter className="flex flex-col gap-3">
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-xs text-muted-foreground">
                  Pagamento 100% seguro via Asaas (PIX)
                </p>
              </div>
            </CardFooter>
          </Card>
