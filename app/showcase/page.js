...
import { ShoppingCart, Star, Heart, Image as ImageIcon, Trash2 } from "lucide-react";

/**
 * Página de showcase demonstrando todos os componentes padronizados
 */
export default function ComponentsShowcase() {
  ...
  const mockPhotos = [
    ...
    },
    {
      ...
      previewUrl: "https://images.unsplash.com/photo-1514565131-fce0801e5785?w=400",
      colecaoId: "col-1",
      preco: 15.0
    },
  ];
  ...
  return (
    <div className="container mx-auto py-12 space-y-16">
      ...
      <section>
        ...
        >
          {!showEmpty && mockPhotos.map(photo => (
            <PhotoCard
              key={photo.id}
              photo={photo}
              onAddToCart={handleAddToCart}
