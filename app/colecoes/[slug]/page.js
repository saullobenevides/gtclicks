  ...
  return (
    // --- Start of New Layout Implementation ---
      ...
      <div className="min-h-screen bg-background pb-20">
        ...
        {/* HERO SECTION */}
        <PageHeader 
          backgroundImage={collection.capaUrl} 
          title={collection.title}
        >
        ...
        <div className="container-wide mt-12 px-4 relative z-0">
             <div className="bg-card/50 border border-white/5 rounded-2xl p-8 max-w-4xl mx-auto backdrop-blur-sm">
