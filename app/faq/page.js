        ...
        */}
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>
              Como recebo as fotos que comprei?
            </AccordionTrigger>
            <AccordionContent>
              Após a confirmação do pagamento, você receberá um e-mail com o
              link de download. Além disso, todas as suas compras ficam salvas
              na área 'Meus Downloads' dentro do seu perfil no site.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              Aceitamos PIX (aprovação imediata) e cartões de crédito. Todas as
              transações são processadas com segurança pelo Mercado Pago ou
              Stripe.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              O GTClicks oferece uma das melhores taxas do mercado. O fotógrafo
              recebe uma porcentagem competitiva do valor de cada venda
              realizada. O saldo é acumulado em sua carteira virtual.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-4">
            <AccordionTrigger>
              Posso usar as fotos comercialmente?
            </AccordionTrigger>
            <AccordionContent>
              Depende da licença adquirida. A 'Licença de Uso Pessoal' é
              restrita a uso próprio. Para publicidade, sites de empresas ou
              materiais de marketing, você deve adquirir a 'Licença Comercial'
              ou 'Estendida', conforme disponível na foto.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-5">
            <AccordionTrigger>
              Como faço para vender minhas fotos?
            </AccordionTrigger>
            <AccordionContent>
              Basta criar uma conta, acessar o painel 'Seja Fotógrafo' e
              completar seu cadastro. Após a aprovação, você poderá criar
              coleções e fazer upload de suas imagens, definindo os preços que
              desejar.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
