    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Os repasses aos fotógrafos são feitos automaticamente via Stripe
          Connect. Esta página mostra solicitações antigas (sistema legado).
        </p>
      </div>

      <Alert className="border-amber-500/30 bg-amber-500/5">
        <AlertCircle className="h-4 w-4" />
        <AlertTitle>Sistema migrado para Stripe</AlertTitle>
        <AlertDescription>
          Novos repasses são automáticos. Saques pendentes antigos não podem
          mais ser aprovados via PIX. Use &quot;Cancelar&quot; e oriente o
          fotógrafo a acessar o painel Financeiro (Stripe).
        </AlertDescription>
      </Alert>
